...
const handleClose = () => {
  ...
  return (
    <div><div ref={profileMenuRef} className='relative flex items-center gap-3 lg:gap-6'>
                        <div className='hidden md:block'>
                            <ProfileDropDown drop={isDrop} open={isDrop} handleClose={handleClose} logout={logout} />
                        </div>
